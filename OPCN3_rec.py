         ...
         #  # print(nl)
            ...
            if T > 20:
             #   print("Reset SPI")
                ...
                #reset SPI  conncetion 
                initOPC(ser)
                print("ERROR - GetHist function")
                data="ERROR - GetHist function"
                return data
            else:
...
if __name__ == "__main__":
    ...
    #start up dance 
        ...
        while True: 
            ...
            if starttime.second % integration == 0: 
                ...
                try: 
                    #intestazione: print("time,b0,b1,b2,b3,b4,b5,b6,b7,b8,b9,b10,b11,b12,b13,b14,b15,b16,b17,b18,b19,b20,b21,b22,b23,MToF,period,FlowRate,OPC-T,OPC-RH,pm1,pm2.5,pm10,Check",file=f)
                    ...
                    print(tnow + "," + str(data['Bin 0']) + ","  + str(data['Bin 1']) + ","  + str(data['Bin 2']) + ","  + str(data['Bin 3']) + ","  + str(data['Bin 4']) + ","  + str(data['Bin 5']) + ","  + str(data['Bin 6']) + ","  + str(data['Bin 7']) + ","  + str(data['Bin 8']) + ","  + str(data['Bin 9']) + ","  + str(data['Bin 10']) + ","  + str(data['Bin 11']) + ","  + str(data['Bin 12']) + ","  + str(data['Bin 13']) + ","  + str(data['Bin 14']) + ","  + str(data['Bin 15']) + ","  + str(data['Bin 16']) + "," + str(data['Bin 17']) + ","+ str(data['Bin 18']) + ","+ str(data['Bin 19']) + ","+ str(data['Bin 20']) + ","+ str(data['Bin 21']) + "," + str(data['Bin 22']) + ","+ str(data['Bin 23']) + ","+ str(data['MToF']) + ","+str(data['period']) + ","+ str(data['FlowRate']) + ","+ str(data['OPC-T']) + ","+ str(data['OPC-RH']) + ","  + str(data['pm1']) + ","  + str(data['pm2.5']) + ","  + str(data['pm10']) +"," + str(data['Check']) , file=f)
                    print(OPCNAME," Time",tnow ," Temp:",str(data['OPC-T'])," RH:",str(data['OPC-RH']), " PM1:", str(data['pm1']) ,"PM2.5:", str(data['pm2.5']) ,"PM10:", str(data['pm10']))
        ...
        #Write nan data, need to keep track of how many time these types of errors occure for data coverage
                ...
                # secondsToWait = integration-secondsToRun
                # if secondsToWait<=0:
                #     print("Warning! RunTime longer than requested sampling interval, skipping one.")
                #     secondsToWait = ((secondsToRun // integration) + 1) * integration - secondsToRun
